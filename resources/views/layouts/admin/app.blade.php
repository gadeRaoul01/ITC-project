                ...
                <ul class="navigation">
                    ...
                    <li>
                        <a href="index.html">
                            ...
                            <span class="mm-text ">Gestion des employés</span>
                        </a>
                    </li>

                    <li>
                        <a>
                            <span class="mm-text ">Paramètre système </span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{route('getCalendar')}}">
                            ...
                            <span class="mm-text ">Gestion des calendriers</span>
                        </a>
                    </li>
                    @endhasanyrole
                    ...
                    <li>
                        <a href="">
                            ...
                            <span class="mm-text ">Collaborateurs</span>
                        </a>
                    </li>
