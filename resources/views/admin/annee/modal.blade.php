...
<div class="modal fade " id="modal-form-annee" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content ">
            <form class="form-horizontal" >
                ...
                <div class="modal-header "
                     style="background-color: #6699cc;border-top-left-radius: inherit;border-top-right-radius: inherit">
                    <h4 class="modal-title-annee" id="myModalLabel" style="color: white"></h4>
                </div>
                <div class="modal-body ">
                    <div class="form-body">
                        <div class="form-group m-t-10">
                            ...
                            <div class="col-md-9">
                                <div class="input-group">
                                    ...
                                    <input class="form-control" placeholder="Veuillez l'année" id="annee"
                                           name="annee">
                                    <input name="idAnnee" id="idAnnee" type="hidden">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary " id="store-annee"></button>
                </div>
            </form>
        </div>
    </div>
